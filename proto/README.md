...
UI 변경 확인: 온보딩, 작가 선택·더보기·더블클릭·롱탭, 대화 버블·스트리밍, 조건부 스낵바, 날짜별 기록, 100자 편지, 예언 재요청, 모바일 바텀시트 스크롤. 공유 설명은 ‘문학으로 마음의 위로를 받아보아요...’이며 공유 이미지는 `assets/onboarding/share-v47.png`이다.
