...
function openFortune(author=state.author,editing=false){
 ...
 if(prophecyPending){
  dialog('세 마녀의 예언',`<section class="fortune-view prophecy-birth" data-prophecy-loading>${intro}${witchesScene()}<p class="fortune-invite" role="status">세 마녀가 작품 속에서<br>그대의 징조를 읽고 있어요.</p><p class="fortune-fine prophecy-caption">오스틴·셰익스피어·체호프의 저장 작품에서<br>구절을 뽑아 세 목소리로 엮고 있어요.</p></section>`);return;
 }
